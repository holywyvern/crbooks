...
public class EditPublisherWindow extends CustomComponent implements EditBaseWindow<Publisher> {
	...
	protected void onFormButtonClick() {
		...
		publisher = Publisher.getByID(this.publisherID);
	...
	public void edit(Publisher item) {
		...
		this.publisherID = item.getPublisherID();
	}
